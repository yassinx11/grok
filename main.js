...
( () => {
    ...
    ( () => {
        ...
        async function l(t={}, s, r, c, u, p, d, g, f="application/json;charset=UTF-8", m={}) {
            ...
            const y = a.callback(t.success) ?? o
              ...
              , w = n("/drivers/call", puter.APIOrigin, puter.authToken, "POST", f);
            ...
            w.onprogress = function() {
                if (!_)
                    return;
                const e = w.responseText.slice(k);
                k = w.responseText.length;
                let t = !1;
                    ...
                    r(i);
                {
                    if (!1 === i.success && "permission_denied" === i.error?.code)
                        return (await puter.ui.requestPermission({
                            permission: "driver:" + c + ":" + p
                        })).granted ? l(t, s, r, c, p, d, g, f, m) : (b(i),
                        r(i));
                    if (!1 === i.success)
                        return b(i),
                        r(i);
        ...
        const m = {
          ...
          , v = ({type: e, data: t}, s, n) => y && t instanceof Blob ? s ? n(t) : _(t, n) : b && (t instanceof ArrayBuffer || w(t)) ? s ? n(t) : _(new Blob([t]), n) : n(g[e] + (t || ""))
          , _ = (e, t) => {
        ...
        function O() {
            return new TransformStream({
                transform(e, t) {
                    !function(e, t) {
                        y && e.data instanceof Blob ? e.data.arrayBuffer().then(k).then(t) : b && (e.data instanceof ArrayBuffer || w(e.data)) ? t(k(e.data)) : v(e, !1, (e => {
                            A || (A = new TextEncoder),
                            t(A.encode(e))
                        }
                        ))
        ...
        const N = M.setTimeout
          , B = M.clearTimeout;
        function q(e, t) {
            t.useNativeTimers ? (e.setTimeoutFn = N.bind(M),
            e.clearTimeoutFn = B.bind(M)) : (e.setTimeoutFn = M.setTimeout.bind(M),
        ...
        class F extends L {
            ...
            onError(e, t, s) {
                return super.emitReserved("error", new j(e,t,s)),
                this
            }
            open() {
        ...
        te.requestsCount = 0,
        te.requests = {},
        "undefined" != typeof document && ("function" == typeof attachEvent ? attachEvent("onunload", se) : "function" == typeof addEventListener && addEventListener("onpagehide"in M ? "pagehide" : "unload", se, !1));
        const ne = "function" == typeof Promise && "function" == typeof Promise.resolve ? e => Promise.resolve().then(e) : (e, t) => t(e, 0)
          , ie = M.WebSocket || M.MozWebSocket
            ...
            websocket: class extends F {
                ...
                uri() {
                    const e = this.opts.secure ? "wss" : "ws"
                      , t = this.query || {};
                    return this.opts.timestampRequests && (t[this.opts.timestampParam] = Y()),
            ...
            polling: class extends F {
                ...
                uri() {
                    const e = this.opts.secure ? "https" : "http"
                      , t = this.query || {};
                    return !1 !== this.opts.timestampRequests && (t[this.opts.timestampParam] = Y()),
        ...
        const ue = "function" == typeof ArrayBuffer
          ...
          , ge = "function" == typeof Blob || "undefined" != typeof Blob && "[object BlobConstructor]" === de.call(Blob)
          , fe = "function" == typeof File || "undefined" != typeof File && "[object FileConstructor]" === de.call(File);
        function me(e) {
            return ue && (e instanceof ArrayBuffer || pe(e)) || ge && e instanceof Blob || fe && e instanceof File
        }
        function ye(e, t) {
        ...
        const ke = ["connect", "connect_error", "disconnect", "disconnecting", "newListener", "removeListener"];
        var Ae;
        function Ie(e) {
        ...
        class Te extends L {
            ...
            add(e) {
                ...
                if ("string" == typeof e) {
                    ...
                    const s = t.type === Ae.BINARY_EVENT;
                    s || t.type === Ae.BINARY_ACK ? (t.type = s ? Ae.EVENT : Ae.ACK,
            ...
            static isPayloadValid(e, t) {
                ...
                case Ae.BINARY_EVENT:
                    return Array.isArray(t) && ("number" == typeof t[0] || "string" == typeof t[0] && -1 === ke.indexOf(t[0]));
                case Ae.ACK:
                case Ae.BINARY_ACK:
        ...
        var Ee = Object.freeze({
            ...
            Encoder: class {
                ...
                encode(e) {
                    return e.type !== Ae.EVENT && e.type !== Ae.ACK || !ye(e) ? [this.encodeAsString(e)] : this.encodeAsBinary({
                ...
                encodeAsString(e) {
                    let t = "" + e.type;
                    return e.type !== Ae.BINARY_EVENT && e.type !== Ae.BINARY_ACK || (t += e.attachments + "-"),
                    e.nsp && "/" !== e.nsp && (t += e.nsp + ","),
                    null != e.id && (t += e.id),
        ...
        function Le(e, t) {
            ...
            const s = function(e, t="", s) {
              ...
              , i = s.id
              , r = s.path
              , o = Re[i] && r in Re[i].nsps;
            let a;
            return t.forceNew || t["force new connection"] || !1 === t.multiplex || o ? a = new De(n,t) : (Re[i] || (Re[i] = new De(n,t)),
            a = Re[i]),
        ...
        const qe = {
            ...
            normalize(e) {
                ...
                return 0 === (e = Be(e, !t, "/", Ne)).length ? t ? "/" : s ? "./" : "." : (s && (e += "/"),
                t ? `/${e}` : e)
            },
        ...
        e)
          ...
          , We = function(...e) {
            ...
            new Promise((async (e, s) => {
                ...
                t.source = Fe(t.source),
                t.destination = Fe(t.destination);
          ...
          , Xe = function(...e) {
            ...
            new Promise((async (e, s) => {
                ...
                void 0 !== t.uid ? o.uid = t.uid : void 0 !== t.path && (o.path = Fe(t.path)),
          ...
          , Ve = async function(s, n, i={}) {
            return new Promise((async (r, o) => {
                const a = globalThis.DataTransfer || class {
                }
                  , c = globalThis.FileList || class {
                }
                  , l = globalThis.DataTransferItemList || class {
                }
                ;
                if (!puter.authToken && "web" === puter.env)
                    try {
                ...
                const h = e => (i.error && "function" == typeof i.error && i.error(e),
                o(e));
                let u = new XMLHttpRequest;
                if ("/" === n)
                    return h("Can not upload to root directory.");
                n = Fe(n);
                const p = t();
                i.init && "function" == typeof i.init && i.init(p, u);
                let d, g = 0, f = 0, m = 0, y = !1;
                if (Array.isArray(s) && s.length > 0)
                    for (let e = 0; e < s.length; e++)
                        (s[e]instanceof a || s[e]instanceof l) && (y = !0);
                if (s instanceof l || s instanceof a || s[0]instanceof a || i.parsedDataTransferItems)
                    d = i.parsedDataTransferItems ? s : await puter.ui.getEntriesFromDataTransferItems(s),
                    d.sort(( (e, t) => e.isDirectory && !t.isDirectory ? -1 : !e.isDirectory && t.isDirectory ? 1 : e.isDirectory && t.isDirectory ? 0 : e.size - t.size));
                else if (s instanceof File || s[0]instanceof File || s instanceof c || s[0]instanceof c) {
                    d = Array.isArray(s) ? s : s instanceof c ? Array.from(s) : [s],
                    d.sort(( (e, t) => e.size - t.size));
                    for (let e = 0; e < d.length; e++)
                        d[e].filepath = d[e].name,
                        d[e].fullPath = d[e].name
                ...
                for (let e = 0; e < d.length; e++)
                    if (d[e]) {
                        if (d[e].isDirectory)
                            w.push({
                                path: je.join(n, d[e].finalPath ? d[e].finalPath : d[e].fullPath)
                            });
                        else {
                            let t = d[e].finalPath ? d[e].finalPath : d[e].fullPath
                        ...
                        void 0 !== d[e].size && (m += d[e].size)
                    }
                if (0 === w.length && 0 === _.length)
                    return h({
                        code: "EMPTY_UPLOAD",
                ...
                w.sort(( (e, t) => t.path.length - e.path.length));
                let A = [];
                for (let e = 0; e < w.length; e++) {
                    for (let t = 0; t < _.length; t++)
                        !_[t].puter_path_param && je.join(n, _[t].filepath).startsWith(w[e].path + "/") && (_[t].puter_path_param = `$dir_${e}/` + je.basename(_[t].filepath));
                    for (let t = 0; t < w.length; t++)
                        !w[t].puter_path_param && w[t].path.startsWith(w[e].path + "/") && (w[t].puter_path_param = `$dir_${e}/` + je.basename(w[t].path))
                }
                for (let e = 0; e < w.length; e++) {
                    let t = je.dirname(w[e].puter_path_param || w[e].path)
                      , s = w[e].puter_path_param || w[e].path;
                    "/" !== t && (s = s.replace(t, "")),
                    A.push({
                        op: "mkdir",
                        parent: t,
                ...
                A.reverse(),
                k.append("operation_id", p),
                k.append("socket_id", this.socket.id),
                k.append("original_client_socket_id", this.socket.id);
                for (let e = 0; e < A.length; e++)
                    k.append("operation", JSON.stringify(A[e]));
                if (!i.shortcutTo)
                    for (let e = 0; e < _.length; e++)
                        k.append("fileinfo", JSON.stringify({
                            name: _[e].name,
                            type: _[e].type,
                            size: _[e].size
                        }));
                for (let e = 0; e < _.length; e++)
                    k.append("operation", JSON.stringify({
                        op: i.shortcutTo ? "shortcut" : "write",
                        dedupe_name: i.dedupeName ?? !0,
                        overwrite: i.overwrite ?? !1,
                        create_missing_ancestors: i.createMissingAncestors || i.createMissingParents,
                        operation_id: p,
                        path: _[e].puter_path_param && je.dirname(_[e].puter_path_param ?? "") || _[e].filepath && je.join(n, je.dirname(_[e].filepath)) || "",
                        name: je.basename(_[e].filepath),
                        item_upload_id: e,
                ...
                if (!i.shortcutTo)
                    for (let e = 0; e < _.length; e++)
                        k.append("file", _[e] ?? "");
                const I = e => {
                    e.operation_id === p && (f += e.loaded_diff)
                }
                ;
                this.socket.on("upload.progress", I);
                let T = null;
                u.open("post", this.APIOrigin + "/batch", !0),
                u.setRequestHeader("Authorization", "Bearer " + this.authToken),
                u.upload.addEventListener("progress", (function(e) {
                    ...
                    T += t,
                    g += t;
                    let s = ((f + g) / m * 100).toFixed(2);
                    s = s > 100 ? 100 : s,
                    i.progress && "function" == typeof i.progress && i.progress(p, s)
                }
                ));
                let x = setInterval((function() {
                    let e = ((f + g) / m * 100).toFixed(2);
                    e = e > 100 ? 100 : e,
                    i.progress && "function" == typeof i.progress && i.progress(p, e)
                }
                ), 100);
                u.onabort = () => {
                    clearInterval(x),
                    this.socket.off("upload.progress", I),
                    i.abort && "function" == typeof i.abort && i.abort(p)
                }
                ,
                u.onreadystatechange = async t => {
                    if (4 === u.readyState) {
                        const t = await e(u);
                        if (u.status >= 400 && u.status < 600 || i.strict && 218 === u.status) {
                            if (clearInterval(x),
                            this.socket.off("upload.progress", I),
                            i.strict && 218 === u.status) {
                                let e;
            ...
            static IMPLEMENTS = {
                [et]: {
                    stat: async function(e) {
                        ...
                        let i = {};
                        return void 0 !== e.uid ? i.uid = e.uid : void 0 !== e.path && (i.path = Fe(e.path)),
        ...
        ;
        class ht extends (globalThis.HTMLElement || Object) {
            ...
            constructor(e, t) {
                ...
                this.launchPopup = () => {
                    try {
                        ...
                        return window.open(puter.defaultGUIOrigin + "/?embedded_in_popup=true&request_auth=true" + (window.crossOriginIsolated ? "&cross_origin_isolated=true" : ""), i, "toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=" + s + ", height=" + n + ", top=" + t + ", left=" + e)
                    } catch (e) {
                        return console.error("Failed to open popup:", e),
                        null
                    }
                }
                ,
            ...
            open() {
                if (this.hasUserActivation()) {
                    ...
                    var e = screen.width / 2 - s / 2
                      , t = screen.height / 2 - n / 2;
                    window.open(puter.defaultGUIOrigin + "/?embedded_in_popup=true&request_auth=true" + (window.crossOriginIsolated ? "&cross_origin_isolated=true" : ""), i, "toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=" + s + ", height=" + n + ", top=" + t + ", left=" + e)
                } else
        ...
        ht.__proto__ === globalThis.HTMLElement && customElements.define("puter-dialog", ht);
        const ut = ht;
        class pt {
            #e;
            #t;
        ...
        class dt extends pt {
            ...
            constructor(e, {target: t, usesSDK: s}) {
                ...
                this.#n = !0,
                this.#i = s,
                this.log = e.puter.logger.fields({
                    category: "ipc"
                }),
                this.log.fields({
                ...
                globalThis.document && window.addEventListener("message", (e => {
        ...
        const gt = class extends pt {
            ...
            constructor(e, {appInstanceID: t, parentInstanceID: s}) {
                ...
                this.parentInstanceID && (this.#o = new dt(this.context,{
                    ...
                    if (e.data.msg && "focus" === e.data.msg)
                        ...
                        if (void 0 === this.#l)
                            ...
                            if (e.data.items.length > 0)
                                for (let s = 0; s < e.data.items.length; s++)
                                    t.push(new lt(e.data.items[s]));
                            this.#l(t)
                        }
                    else if ("getAppDataSucceeded" === e.data.msg) {
                        let t = new lt(e.data.item);
                        ...
                        if ("fileOpenPicked" === e.data.msg) {
                            if (1 === e.data.items.length)
                                this.#a[e.data.original_msg_id](new lt(e.data.items[0]));
                            ...
                            if (1 === e.data.items.length)
                                this.#a[e.data.original_msg_id](new lt({
                        ...
                        e.data.usesSDK = !0;
                        const t = dt.from(e.data, this.context)
                          , s = t => {
                            this.messageTarget?.postMessage({
                                $: "connection-resp",
            ...
            showDirectoryPicker = function(e, t) {
                return new Promise(( (t, s) => {
                    ...
                    if ("app" === this.env)
                        ...
                        window.open(`${puter.defaultGUIOrigin}/action/show-directory-picker?embedded_in_popup=true&msg_id=${n}&appInstanceID=${this.appInstanceID}&env=${this.env}&options=${JSON.stringify(e)}`, o, "toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=" + t + ", height=" + s + ", top=" + r + ", left=" + i)
                    }
                    this.#a[n] = t
                }
                ))
            ...
            showOpenFilePicker = function(e, t) {
                return new Promise(( (t, s) => {
                    ...
                    if ("app" === this.env)
                        ...
                        var i = screen.width / 2 - t / 2
                          , r = screen.height / 2 - s / 2;
                        window.open(`${puter.defaultGUIOrigin}/action/show-open-file-picker?embedded_in_popup=true&msg_id=${n}&appInstanceID=${this.appInstanceID}&env=${this.env}&options=${JSON.stringify(e ?? {})}`, o, "toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=" + t + ", height=" + s + ", top=" + r + ", left=" + i)
                    }
                    this.#a[n] = t
                }
                ))
                ...
                return new Promise(( (n, i) => {
                    ...
                    if ("app" === this.env)
                        ...
                        let s = new Blob([e],{
                          ...
                          , a = 400
                          , h = "Puter: Save File";
                        var c = screen.width / 2 - i / 2
                          , l = screen.height / 2 - a / 2;
                        window.open(`${puter.defaultGUIOrigin}/action/show-save-file-picker?embedded_in_popup=true&msg_id=${r}&appInstanceID=${this.appInstanceID}&env=${this.env}&blobUrl=${encodeURIComponent(n)}`, h, "toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=" + i + ", height=" + a + ", top=" + l + ", left=" + c)
                    }
                    this.#a[r] = n
                }
                ))
            ...
            disableMenuItem = function(e) {
                this.#f("disableMenuItem", {
                    id: e
                })
            }
            ;
            enableMenuItem = function(e) {
                this.#f("enableMenuItem", {
                    id: e
                })
            }
            ;
            setMenuItemIcon = function(e, t) {
                this.#f("setMenuItemIcon", {
                    id: e,
                    icon: t
                })
            }
          ...
          , ft = ["has_set_default_app_user_permissions", "window_sidebar_width", "sidebar_items", "menubar_style", "user_preferences.auto_arrange_desktop", "user_preferences.show_hidden_files", "user_preferences.language", "user_preferences.clock_visible", "toolbar_auto_hide_enabled", "has_seen_welcome_window"];
        function mt(e, t) {
            let s = (n = e,
        ...
        const yt = class {
            ...
            constructor(e) {
                ...
                (async () => {
                    ...
                    if (!Array.isArray(t?.result))
                        return this.gui_cached.resolve({}),
                        void setTimeout(( () => {
            ...
            async get(...e) {
                return "string" == typeof e[0] && ft.includes(e[0]) && null !== this.gui_cached ? (this.gui_cache_init && this.gui_cache_init.resolve(),
            ...
            expire = async (...e) => {
                ...
                return c(["key"], "puter-kvstore", void 0, "expire").call(this, t)
            }
            ;
            ...
            list = async (...e) => {
                ...
                c([], "puter-kvstore", void 0, "list", {
                    transform: e => t ? n ? e.filter((e => mt(t, e.key))) : e.filter((e => mt(t, e))) : e
                }).call(this, s)
            }
            ;
          ...
          , bt = class {
            ...
            txt2speech = async (...e) => {
                ...
                if (t.engine) {
                    const e = ["standard", "neural", "long-form", "generative"];
                    if (!e.includes(t.engine))
                        throw {
                            message: "Invalid engine. Must be one of: " + e.join(", "),
                            code: "invalid_engine"
                        }
                }
                if (t.voice || (t.voice = "Joanna"),
                ...
                return await c(["source"], "puter-tts", "aws-polly", "synthesize", {
                    responseType: "blob",
                    test_mode: s ?? !1,
                    transform: async e => {
                        const t = await u(e)
            ...
            txt2speech = Object.assign(this.txt2speech, {
                listEngines: async () => await c(["source"], "puter-tts", "aws-polly", "list_engines", {
                    responseType: "text"
                }).call(this, {}),
                listVoices: async e => {
                    const t = {};
                    return e && (t.engine = e),
                    c(["source"], "puter-tts", "aws-polly", "list_voices", {
                        responseType: "text"
                    }).call(this, t)
                }
            });
            chat = async (...e) => {
                ...
                "claude-sonnet-4" !== t.model && "claude-sonnet-4-latest" !== t.model || (t.model = "claude-sonnet-4-20250514"),
                "claude-opus-4" !== t.model && "claude-opus-4-latest" !== t.model || (t.model = "claude-opus-4-20250514"),
                ...
                !t.model || t.model.startsWith("gpt-") ? i = "openai-completion" : t.model.startsWith("claude-") ? i = "claude" : "meta-llama/Meta-Llama-3.1-8B-Instruct-Turbo" === t.model || "meta-llama/Meta-Llama-3.1-70B-Instruct-Turbo" === t.model || "meta-llama/Meta-Llama-3.1-405B-Instruct-Turbo" === t.model || "google/gemma-2-27b-it" === t.model ? i = "together-ai" : t.model.startsWith("mistral-") || t.model.startsWith("codestral-") || t.model.startsWith("pixtral-") || t.model.startsWith("magistral-") || t.model.startsWith("devstral-") || t.model.startsWith("mistral-ocr-") || t.model.startsWith("open-mistral-") ? i = "mistral" : ["distil-whisper-large-v3-en", "gemma2-9b-it", "gemma-7b-it", "llama-3.1-70b-versatile", "llama-3.1-8b-instant", "llama3-70b-8192", "llama3-8b-8192", "llama3-groq-70b-8192-tool-use-preview", "llama3-groq-8b-8192-tool-use-preview", "llama-guard-3-8b", "mixtral-8x7b-32768", "whisper-large-v3"].includes(t.model) ? i = "groq" : "grok-beta" === t.model ? i = "xai" : "deepseek-chat" === t.model || "deepseek-reasoner" === t.model ? i = "deepseek" : "gemini-1.5-flash" === t.model || "gemini-2.0-flash" === t.model ? i = "gemini" : t.model.startsWith("openrouter:") && (i = "openrouter"),
          ...
          , vt = "9a9c83a4-7897-43a0-93b9-53217b84fde6";
        class _t {
            #v = 1;
            constructor() {
            ...
            attach_to_source(e) {
                e.addEventListener("message", (e => {
                    const {data: t} = e;
                    if (t && "object" == typeof t && t.$SCOPE === vt) {
                        const {id: e, args: s} = t
        ...
        class At {
            ...
            hydrate_value_(e) {
                if (e && "object" == typeof e && e.$SCOPE === vt) {
                    const {id: t} = e;
                    return (...e) => {
        ...
        class Rt extends $e.concepts.Service {
            static PROPERTIES = {};
        ...
        const {TTopics: Lt} = $e.traits;
        class Mt extends $e.concepts.Service {
            static TOPICS = ["update"];
            static PROPERTIES = {
                auth_token: {
                    post_set(e) {
                        this.as(Lt).pub("update")
                    }
                },
                api_origin: {
                    post_set() {
        ...
        const Ut = $e.libs.promise.TeePromise;
        ...
        class Bt extends $e.concepts.Service {
            _init() {
                if (globalThis.when_puter_happens && (!puter || "gui" === puter.env)) {
                    Array.isArray(globalThis.when_puter_happens) || (globalThis.when_puter_happens = [globalThis.when_puter_happens]);
        ...
        class qt {
            ...
            _init() {
                ...
                e = e.split(";");
                for (const t of e)
                    "" !== t && this.context.puter.logger.on(t);
                globalThis.addEventListener("message", (async e => {
                    e.source === globalThis.parent && e.data.$ && "puterjs-debug" === e.data.$ && (console.log("Got a puter.js debug event!", e.data),
        ...
        function Wt(e) {
            ...
            switch (e.packetType) {
            case 1:
                e.hostEncoded = Ft.encode(e.hostname),
            ...
            case 5:
                t += 2,
                e.password && (t += 6),
                e.puterAuth && (e.passwordEncoded = Ft.encode(e.puterAuth),
        ...
        class Ht extends pt {
            ...
            constructor(e, t) {
                ...
                (async () => {
                    if (!puter.authToken && puter.env,
                    !Kt.handler) {
                        const {token: e, server: t} = await (await fetch(puter.APIOrigin + "/wisp/relay-token/create", {
                            method: "POST",
                            headers: {
                        ...
                        Kt.handler = new Xt(t,e),
                        await new Promise(( (e, t) => {
                            Kt.handler.onReady = e
                        }
                        ))
                    }
                    const s = {
                        ...
                        closeCallBack: e => {
                            if (2 !== e)
                                return this.emit("error", new Error(zt[e])),
            ...
            return new Promise((async (t, s) => {
                try {
                    const n = new Request(...e)
                      , i = new URL(n.url);
                    let r, o = new Headers(n.headers);
                    "http:" === i.protocol ? r = new puter.net.Socket(i.hostname,i.port || 80) : "https:" === i.protocol ? r = new puter.net.tls.TLSSocket(i.hostname,i.port || 443) : s(`Failed to fetch. URL scheme "${i.protocol}" is not supported.`),
                    o.get("user-agent") || o.set("user-agent", navigator.userAgent);
                    let a, c = `${n.method} ${i.pathname}${i.search} HTTP/1.1\r\nHost: ${i.host}\r\nConnection: close\r\n`;
                    for (const [e,t] of o)
                        c += `${e}: ${t}\r\n`;
                    if (n.body) {
                        if (a = new Uint8Array(await n.arrayBuffer()),
                        o.has("content-length")) {
                            if (o.get("content-length") !== String(a.length))
                                return s("Content-Length header does not match the body length. Please check your request.")
                        } else
                            o.set("content-length", a.length);
                                ...
                                -1 !== h.indexOf("\r\n\r\n")) {
                                    ...
                                    const i = function(...e) {
                                        ...
                                        return e.forEach(( (e, t, n) => {
                                            const i = n.slice(0, t).reduce(( (e, t) => e + t.length), 0);
                                            s.set(e, i)
                                        }
                                        )),
                                        s
        ...
        var es = {}
          , ts = {};
        es.length = 0,
        es.getItem = function(e) {
            return e in ts ? ts[e] : null
        }
        ,
        es.setItem = function(e, t) {
            void 0 === t ? es.removeItem(e) : (ts.hasOwnProperty(e) || es.length++,
            ts[e] = "" + t)
        }
        ,
        es.removeItem = function(e) {
            ts.hasOwnProperty(e) && (delete ts[e],
            es.length--)
        }
        ,
        es.key = function(e) {
            return Object.keys(ts)[e] || null
        }
        ,
        es.clear = function() {
            ts = {},
        ...
        ,
        "object" == typeof exports && (module.exports = es);
        const ss = es
          , ns = Symbol("readyState")
          , is = Symbol("headers")
          , rs = Symbol("response headers")
          , os = Symbol("AbortController")
          , as = Symbol("method")
          , cs = Symbol("URL")
          , ls = Symbol("MIME")
          , hs = Symbol("dispatch")
          ...
          , ps = Symbol("timeout")
          , ds = Symbol("timedOut")
          , gs = Symbol("isResponseText")
          , fs = class extends EventTarget {
            onreadystatechange() {}
            set readyState(e) {
                this[ns] = e,
            ...
            constructor() {
                ...
                this[is].accept = "*/*",
                this[rs] = Object.create(null),
                this[os] = new AbortController,
                this[as] = "",
                this[cs] = "",
                this[ls] = "",
                this[us] = !1,
            ...
            get responseText() {
                if (this[us])
                    return null;
                if (this.readyState < this.constructor.HEADERS_RECEIVED)
                    return "";
                if (this[gs])
            ...
            setRequestHeader(e, t) {
                ...
                void 0 === this[is][e] ? this[is][e] = String(t) : this[is][e] += `, ${t}`
            }
            overrideMimeType(e) {
                this[ls] = String(e)
            }
            getAllResponseHeaders() {
                return this[us] || this.readyState < this.constructor.HEADERS_RECEIVED ? "" : Array.from(this[rs].entries().map(( ([e,t]) => `${e}: ${t}`))).join("\r\n")
            }
            getResponseHeader(e) {
                const t = this[rs].get(String(e).toLowerCase());
                return "string" == typeof t ? t : null
            }
            send(e=null) {
                this.timeout > 0 && (this[ps] = setTimeout(( () => {
                    this[ds] = !0,
                    this[os].abort()
                }
                ), this.timeout));
                ...
                fetch(this[cs], {
                    ...
                    this[rs] = e.headers;
                    const s = this[ls] || this[rs].get("content-type") || "text/plain";
                    switch (t) {
                    case "text":
                        this.response = await e.text();
                        break;
                    case "blob":
                        this.response = new Blob([await e.arrayBuffer()],{
                            type: s
                        });
                        break;
                    case "arraybuffer":
                        this.response = await e.arrayBuffer();
                        break;
                    case "json":
                        this.response = await e.json()
                    }
                    this.readyState = this.constructor.DONE,
                    this[hs](new CustomEvent("load"))
                }
                ), (e => {
                    let t = "abort";
                    "AbortError" !== e.name ? (this[us] = !0,
                    t = "error") : this[ds] && (t = "timeout"),
                    this.readyState = this.constructor.DONE,
                    this[hs](new CustomEvent(t))
                }
                )).finally(( () => this[hs](new CustomEvent("loadend")))).finally(( () => {
                    clearTimeout(this[ps]),
                    this[hs](new CustomEvent("loadstart"))
                }
                ))
            }
        }
        ;
        "object" == typeof module && module.exports ? module.exports = fs : (globalThis || self).XMLHttpRequestShim = fs;
        const ms = fs;
        class ys {
            constructor(e) {
                this.authToken = e
            ...
            async create(e, t) {
                const s = await puter.fs.read(t).then((e => e.text()));
                let n = await puter.kv.get("user-workers");
                n || (n = {});
                const i = await puter.drivers.call("workers", "worker-service", "create", {
                    authorization: puter.authToken,
                    fileData: s,
                    workerName: e
                })
                  , r = JSON.parse(i.result);
                if (!i.success || !r.success)
                    throw new Error(r?.errors || "Driver failed to execute, do you have the necessary permissions?");
                return n[e] = {
                    filePath: t,
                    url: r.url,
                    deployTime: Date.now()
            ...
            async update(e) {
                let t = (await puter.kv.get("user-workers"))[e].filePath;
            ...
            async get(e) {
                try {
                    return (await puter.kv.get("user-workers"))[e].url
                } catch (e) {
                    throw new Error("Failed to get worker")
                }
            }
            async delete(e) {
                const t = await puter.drivers.call("workers", "worker-service", "destroy", {
                    authorization: puter.authToken,
                    workerName: e
                });
                if (t.success && t.result.result) {
        ...
        globalThis.puter = function() {
            const e = new class {
                ...
                initSubmodules = function() {
                    this.util = new It,
                    this.registerModule("auth", wt),
                    this.registerModule("os", d),
                    ...
                    this.registerModule("apps", ct),
                    this.registerModule("ai", bt),
                    this.registerModule("kv", yt),
                    this.registerModule("threads", Zt),
                    this.registerModule("perms", Jt),
                ...
                constructor(e) {
                    ...
                    let s = new URLSearchParams(globalThis.location?.search);
                    s.has("puter.app_instance_id") ? this.env = "app" : !0 === globalThis.puter_gui_enabled ? this.env = "gui" : globalThis.WorkerGlobalScope ? (globalThis.ServiceWorkerGlobalScope ? (this.env = "service-worker",
                    globalThis.XMLHttpRequest || (globalThis.XMLHttpRequest = ms),
                    globalThis.location || (globalThis.location = new URL("https://puter.site/"))) : this.env = "web-worker",
                    globalThis.localStorage || (globalThis.localStorage = ss)) : globalThis.process ? (this.env = "nodejs",
                    globalThis.localStorage || (globalThis.localStorage = ss),
                    globalThis.XMLHttpRequest || (globalThis.XMLHttpRequest = ms),
                    ...
                    const i = n;
                    if (this.logger = new $e.libs.log.LoggerFacade({
                        impl: n,
                        cat: i
                    }),
                    this.services.register("no-puter-yet", Bt),
                    this.services.register("filesystem", Rt),
                    this.services.register("api-access", Mt),
                    this.services.register("xd-incoming", Nt),
                    "app" !== this.env && this.services.register("fs-relay", Ot),
                    (async () => {
                    ...
                    "gui" === this.env)
                        ...
                        "web-worker" !== this.env && "service-worker" !== this.env && "nodejs" !== this.env || this.initSubmodules();
                    (async () => {
                        await this.services.wait_for_init(["api-access"]);
                    ...
                    this.workers = new ys(this.authToken)
                }
                async request_rao_() {
                ...
                print = function(...e) {
                    ...
                    for (let s of e)
                        !0 !== t.escapeHTML && !0 !== t.code || "string" != typeof s || (s = s.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#039;")),
